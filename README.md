...
### 게임의 진행 순서
게임이 시작되면 플레이어(상담사)에게 4명의 내담자가 배정됩니다.<br>
플레이어는 4명 중 1명을 선택해 상담을 시작합니다.<br>
내담자의 현재 고민을 확인하고, 플레이어가 조언(상담 내용)을 텍스트로 입력합니다.<br>
상담을 마친 후, 턴이 1 증가합니다.<br>

### 점수 시스템
플레이어가 조언을 제출하면, 내담자(LLM)는 그 조언을 바탕으로 -5점에서 +5점 사이의 점수를 내부적으로 평가합니다.<br>
이 점수는 해당 내담자의 **만족도**에 누적됩니다.<br>
...
6. 보이지 않는 삶들 : 인생의 선택들에 대해 누적된 결과를 보여주는 게임 
